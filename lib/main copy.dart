...
//     //   int imStart = efDg2.indexOf(0xFFD8FFE0);
//     //   if (imStart == -1) {
//     //     imStart = efDg2.indexOf(0x0000000C6A50);
//     //   }
//     //   Uint8List image = efDg2.sublist(imStart);
//     //   return image;
//     // }

//     // final iamge = getJpegIm(dataText);
//     // print(iamge);
...
//                 children: [
//                   // here
//                   // if (haveImage) Image.memory(iamge),
//                   // IImage.memory(bytes);
//                   PlatformTextButton(
//                     child: Text('Copy'),
//                     onPressed: () =>
...
//                     final lastDate =
//                         DateTime(now.year + 20, now.month + 6, now.day);
