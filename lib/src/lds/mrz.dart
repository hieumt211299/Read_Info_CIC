...
class MRZ {
  ...
  String _toString() {
    return 'MRZ{country: $country, dateOfBirth: $dateOfBirth, dateOfExpiry: $dateOfExpiry, documentCode: $documentCode, documentNumber: $documentNumber, firstName: $firstName, lastName: $lastName, nationality: $nationality, optionalData: $optionalData, optionalData2: $optionalData2, gender: $gender, version: $version}';
  }
}
